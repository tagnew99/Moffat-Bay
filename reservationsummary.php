...
if (!isset($_SESSION['room_size']) || !isset($_SESSION['selected_guests']) || !isset($_SESSION['check_in_date']) || !isset($_SESSION['check_out_date'])) {
...
<body>
    ...
    <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
        <div class="center-box">
            ...
            <p><strong>Number of Guests:</strong> <?php echo $_SESSION['selected_guests']; ?></p>
            ...
            <?php if (!empty($_SESSION['activities'])): ?>
                <p><strong>Selected Activities:</strong> <?php echo implode(', ', $_SESSION['activities']); ?></p>
            <?php endif; ?>
