...
if (!isset($_SESSION['username'])) {
    ...
    echo "<script>alert('You must be logged in to make a reservation.');</script>";
}
?>
...
<head>
    ...
    <script>
        // JavaScript function to calculate price based on room size, number of guests, and selected activities
        function calculatePrice() {
            ...
            // Adjust base price based on room size
            var basePrice = 115; // Default base price
            if (roomSize === "queen") {
                basePrice *= 1.5;
            } else if (roomSize === "double_queen") {
                basePrice *= 1.5 * 1.5;
...
<body>
    ...
    <!-- Main form wrapper with forms on the left and images on the right -->
