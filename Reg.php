...
<head>
    ...
    <style>
        .main-content{
            background-image: url('Images/Reg_Background3.jpg'); /* Set background image for the body */
        ...
        .container2 {
            ...
            position: relative; /* Set position to relative to allow absolute positioning of child elements */
            overflow: hidden; /* Hide overflow to prevent background from extending beyond container */
        }

        .container2-content {
            position: relative; /* Set position to relative for proper stacking of content */
            z-index: 2; /* Ensure the content is on top of the background */
            padding: 20px; /* Add padding to the content to prevent overlap with the overlay */
        }
    ...
    <div class="container2">
        <div class="container2-content">
            ...
            <form action="registerhandler.php" method="post" onsubmit="return validatePassword()">
                ...
                <input type="text" id="confirm_password" name="confirm_password" placeholder="Confirm Password" required><br>
